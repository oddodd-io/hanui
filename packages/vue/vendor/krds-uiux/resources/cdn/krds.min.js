  ...
  krds_tooltip = {
    ...
    init() {
      ((this.tooltip = document.querySelectorAll('.krds-tooltip')),
        ...
        this.tooltip.length &&
          (this.setupTooltips(), this.setupGlobalEvents()));
    },
    setupTooltips() {
            ...
            if (
              ...
              if ('auto' === r.slidesPerView) {
                ...
                ((o = (l - (r.slidesPerView - 1) * w) / r.slidesPerView),
                  r.roundLengths && (o = Math.floor(o)),
                  p[s] &&
                    (p[s].style[i.getDirectionLabel('width')] = o + 'px'));
          ...
          setTranslate: () => {
            ...
            for (let o = 0; o < d.length; o += 1) {
              ...
              (t % 4 == 0
                ...
                c && (r = -r),
                m || ((l = r), (r = 0)));
              var g = `rotateX(${m ? 0 : -a}deg) rotateY(${m ? a : 0}deg) translate3d(${r}px, ${l}px, ${n}px)`;
              (i <= 1 &&
                -1 < i &&
                ((v = 90 * t + 90 * i),
                c && (v = 90 * -t - 90 * i),
            ...
            if (
              ...
              if (m)
                l.style.transform = `translate3d(0px, ${a / 2 + u.shadowOffset}px, ${-a / 2}px) rotateX(89.99deg) rotateZ(0deg) scale(${u.shadowScale})`;
              else {
